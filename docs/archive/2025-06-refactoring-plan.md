# Refactoring plan (archived, 2025-06)

> **Archived document.** This is a historical planning record from June 2025, kept for context. It does not describe current behavior. Most of the work described here is now implemented — see [Makefile.md](../../Makefile.md) for the current target reference. For current documentation, start with the [README](../../README.md).
