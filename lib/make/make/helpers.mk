...
# Generate the Make target reference in Markdown
help/doc:
	@printf -- "<!--\n" > Makefile.md
	@printf -- "  ** MANAGED BY AWS CODE HABITS\n" >> Makefile.md
	@printf -- "  ** DO NOT EDIT THIS FILE\n" >> Makefile.md
	@printf -- "  **\n" >> Makefile.md
	@printf -- "  ** Run \`make help/doc\` to rebuild this file.\n" >> Makefile.md
	@printf -- "  **\n" >> Makefile.md
	@printf -- "-->\n\n" >> Makefile.md
	@printf -- "# Make target reference\n\n" >> Makefile.md
	@printf -- "Every documented \`make\` target the library exposes, with a one-line description.\n\n" >> Makefile.md
	@printf -- "## Targets\n\n" >> Makefile.md
	@printf '```text\n' >> Makefile.md
	@printf -- "Available targets:\n\n" >> Makefile.md
